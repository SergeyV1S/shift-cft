...
const SelectTrigger = ({
  ...
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-12 max-md:h-10 w-full rounded-xl border border-input bg-transparent px-3 py-1 text-sm shadow-sm transition-colors max-md:placeholder:text-xs max-md:text-xs items-center justify-between ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
      className
    )}
    {...props}
  >
